...
<!-- Put this in your apache document root to access it over your local network. You may need to change some information below to make it link to the correct files and directories in ~/linkapp -->
...
if (isset($url)) {
        ...
        fwrite($fh,$url);
        fclose($fh);
        #Safely executes in firefox. Make sure you have changed the settings for www-data user. See README for more info. Change {username} to your user name.
